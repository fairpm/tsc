# **FAIR Slack Community Guidelines v1.0**
...
We reserve the right to update these guidelines periodically to address new scenarios or enhance clarity. When we do, we’ll communicate updates in the \#announcements channel.
...
* Use inclusive language and interpret each other’s contributions generously.
* Support each other and share knowledge freely. 💪
* Celebrate each other’s milestones and contributions. 🎉 ✨ ⭐️
...
* Harassment or derogatory comments about someone’s identity or personal attributes (race, gender, sexual orientation, disability, appearance, religion, nationality, political views, etc.).
...
* Each admin’s Slack profile will include "FAIR Slack Admin" and their respective time zone.
